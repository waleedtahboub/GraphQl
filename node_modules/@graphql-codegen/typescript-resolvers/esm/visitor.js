...
import { BaseResolversVisitor, DEFAULT_SCALARS, getConfigValue, normalizeAvoidOptionals, } from '@graphql-codegen/visitor-plugin-common';
...
export class TypeScriptResolversVisitor extends BaseResolversVisitor {
    constructor(pluginConfig, schema, federationMeta) {
        super(pluginConfig, {
        ...
        }, schema, DEFAULT_SCALARS, federationMeta);
        autoBind(this);
